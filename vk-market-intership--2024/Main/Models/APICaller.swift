...
class APICaller {
    ...
    private var params: [String: String] = [
                                            "current": "temperature_2m,relative_humidity_2m,apparent_temperature,cloud_cover,surface_pressure,wind_speed_10m,uv_index",
    ...
    public func fetchDataTest() {
        let url = try! createURLRequest(params: params)
